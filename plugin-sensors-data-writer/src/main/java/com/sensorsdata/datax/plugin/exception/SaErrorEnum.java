...
public enum SaErrorEnum implements ErrorCode {
  ...
  UNKNOWN_EVENT_TYPE("UNKNOWN_EVENT_TYPE", "writer 配置文件中 eventType 类型不支持."),
  NONE_KEY_TRACK("NONE_KEY_TRACK", "writer 配置文件中 eventType=event 但没有配置 track 节点信息."),
  NONE_KEY_PROFILE_SET("NONE_KEY_PROFILE_SET", "writer 配置文件中 eventType=user 但是没有配置 profileSet 节点信息."),
  NONE_KEY_ITEM_SET("NONE_KEY_ITEM_SET", "writer 配置文件中 eventType=item 但是没有配置 itemSet 节点信息."),
