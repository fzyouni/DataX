...
public enum SaSdkFactory {
  ...
  public void initSdkNetAddress(String netAddress, int bulkSize, int timeoutSec) {
    netInstance = new SensorsAnalytics(new BatchConsumer(netAddress, bulkSize, timeoutSec));
  }

  public void initSdkLogAddress(String logAddress, int bulkSize) {
    logInstance = new SensorsAnalytics(new ConcurrentLoggingConsumer(logAddress, bulkSize));
  }
