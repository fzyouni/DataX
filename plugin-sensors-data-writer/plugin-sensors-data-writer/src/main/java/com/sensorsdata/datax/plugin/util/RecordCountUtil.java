...
public class RecordCountUtil {
  ...
  private static final AtomicLong BAD_RECORD_COUNT = new AtomicLong();
  ...
  public static Long getBadRecordCount() {
    return BAD_RECORD_COUNT.get();
  }
  ...
  public static void incBadRecordCount(){
    BAD_RECORD_COUNT.getAndIncrement();
  }
